...
import com.example.zotcard.Helper.DatabaseContract;
...
//import com.example.zotcard.CustomViews.WelcomeScreen.WelcomeDialog;
//import com.example.zotcard.Helper.DownloadMp3Async;
 ...
 */
public class Algebra2CardActivity extends AppCompatActivity implements FragmentStatePager.EmptyInterface, View.OnClickListener, SpinnerInteractionListener.SpinnerListener {
     ...
     */
    private final ArrayList<SetModel> sets = new ArrayList<>();
    /**
...
//        }
        ...
        current_set = new SetModel("Set 1", "test_deck_3/deck");
